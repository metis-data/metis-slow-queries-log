...
const query6_helper_check_if_postgres_fdw_extension_available = `SELECT extname FROM pg_extension as pe where pe.extname = 'log_fdw';`;
...
const query9_get_active_and_idle_connections = (databaseName) => `SELECT datname as database, 
...
GROUP BY datname
ORDER BY datname`;
exports.query9_get_active_and_idle_connections = query9_get_active_and_idle_connections;
const query10_get_db_size_pretty_mode = `SELECT pg_size_pretty( pg_database_size(current_database()))`;
exports.query10_get_db_size_pretty_mode = query10_get_db_size_pretty_mode;
const query11_get_db_version = `SELECT substring(version() from 'PostgreSQL ([0-9]+.[0-9]+)')`;
exports.query11_get_db_version = query11_get_db_version;
